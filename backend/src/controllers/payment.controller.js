...
// import {instance}  from "../app.js" // Razorpay instance commented out - not needed
...
const coursePayment = asyncHandler(async(req,res)=>{
    // Payment functionality disabled - Razorpay not needed
    throw new ApiError(501, "Payment functionality is currently disabled")
